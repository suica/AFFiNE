import { GoogleAuth } from '@affine/datacenter';
...
export class BackgroundWebsocket extends websocket.WebsocketClient {
  public shouldReconnect = false;
  private _retryTimes = 0;
  private _auth: GoogleAuth;
  private _logger = new DebugLogger('affine:background-websocket');
  constructor(
    serverUrl: string,
    auth: GoogleAuth,
